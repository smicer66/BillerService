package com.syncstate.probase.bills.BillerService.exception;
...
//@Component
public class BillerServiceAuthException extends Exception/*Throwable implements ResponseErrorHandler*/ {

    private Logger logger = LoggerFactory.getLogger(this.getClass());
//    private String errorMessage = null;


    public BillerServiceAuthException(String message)
    {
        super(message);
    }
