package com.syncstate.probase.bills.BillerService.util;
...
public class UtilityHelper {
    ...
    public static String uploadFile(MultipartFile farmersListFile, String fileDestinationPath) throws IOException {
        byte[] fileBytes = farmersListFile.getBytes();
        String pathName = farmersListFile.getOriginalFilename();
